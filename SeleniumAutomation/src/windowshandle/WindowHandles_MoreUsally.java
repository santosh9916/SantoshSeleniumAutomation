...
public class WindowHandles_MoreUsally {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Print no. of ChildWindows are:"
				+ childWindows.size());
		...
		while (iterator.hasNext()) {
			String windows = (String) iterator.next();
		...
		// Using for-each Loop
		/*
		 * for (String windows : childWindows) { if
		 * (mainWindow.equalsIgnoreCase(windows)) {
		 * System.out.println("Already Selenium focus on main window"); }else{
		 * driver.switchTo().window(windows); Thread.sleep(3000);
		 * driver.findElement(By.id("q")).sendKeys("selenium");
